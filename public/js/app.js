...
Vue.use(vue_axios__WEBPACK_IMPORTED_MODULE_1__["default"], (axios__WEBPACK_IMPORTED_MODULE_2___default())); // import HomeComponent from './components/HomeComponent.vue';
...
var app = new Vue(Vue.util.extend({
  router: router
}, (_App_vue__WEBPACK_IMPORTED_MODULE_3___default()))).$mount('#app');
